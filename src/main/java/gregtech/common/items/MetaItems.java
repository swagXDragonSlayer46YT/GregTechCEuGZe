...
public final class MetaItems {
    ...
    public static MetaItem<?>.MetaValueItem EMITTER_GAMMA;
    public static MetaItem<?>.MetaValueItem EMITTER_GRAVITATION;
    public static MetaItem<?>.MetaValueItem EMITTER_SONIC;
    public static MetaItem<?>.MetaValueItem EMITTER_ELECTRON;
    public static MetaItem<?>.MetaValueItem EMITTER_LED;

    public static MetaItem<?>.MetaValueItem SENSOR_LIGHT;
    public static MetaItem<?>.MetaValueItem SENSOR_RADIO;
    public static MetaItem<?>.MetaValueItem SENSOR_INFRARED;
    public static MetaItem<?>.MetaValueItem SENSOR_SONIC;
    public static MetaItem<?>.MetaValueItem SENSOR_ELECTRICITY;
    public static MetaItem<?>.MetaValueItem LASER_ND_YAG;
