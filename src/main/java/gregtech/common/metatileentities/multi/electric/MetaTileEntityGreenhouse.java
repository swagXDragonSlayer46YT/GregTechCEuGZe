...
public class MetaTileEntityGreenhouse extends RecipeMapMultiblockController {
    ...
    protected IBlockState getCasingState() {
        return MetaBlocks.TRANSPARENT_CASING.getState(BlockGlassCasing.CasingType.GREENHOUSE_GLASS);
    }
    ...
    public void addInformation(ItemStack stack, @Nullable World player, List<String> tooltip, boolean advanced) {
        ...
        tooltip.add(I18n.format("gregtech.machine.greenhouse.tooltip.1"));
        tooltip.add(I18n.format("gregtech.machine.greenhouse.tooltip.2"));
        tooltip.add(I18n.format("gregtech.machine.greenhouse.tooltip.3"));
    }
