...
public class MetaTileEntityMobExterminator extends TieredMetaTileEntity {
        ...
        if (isWorkingNow) {
            ...
            if (!mobs.isEmpty()) {
                ...
                for (int i = 0; i < loopLength; i++) {
                    ...
                    mobs.get(i).attackEntityFrom(DamageSources.getExterminationDamage(this.getWorld()), 40);
                    if (i > 3) {
    ...
    public void addInformation(ItemStack stack, @Nullable World player, List<String> tooltip, boolean advanced) {
        ...
        tooltip.add(I18n.format("gregtech.machine.mob_exterminator.tooltip.warning"));
    }
