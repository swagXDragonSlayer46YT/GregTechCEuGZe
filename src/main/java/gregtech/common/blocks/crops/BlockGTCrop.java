...
public class BlockGTCrop extends BlockCrops {
    ...
    public static List<BlockGTCrop> CROP_BLOCKS = new ArrayList<>();
    private String name;

    protected BlockGTCrop(String name, int age) {
        ...
        this.setRegistryName("gregtech", "crop_" + name);
        CROP_BLOCKS.add(this);
        this.name = name;
        this.setTranslationKey("gregtech_crop_" + name);
    }

    protected BlockGTCrop(String name) {
        this(name, 5);
    }

    public static BlockGTCrop create(String name) {
        AGE_TEMP = PropertyInteger.create("age", 0, 5);
        return new BlockGTCrop(name);
    }
