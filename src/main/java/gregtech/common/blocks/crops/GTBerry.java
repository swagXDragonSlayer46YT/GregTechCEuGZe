...
import gregtech.common.worldgen.GTBerryGen;
...
public class GTBerry extends GTFeature {
    public final BlockGTBush berryBush;

    public GTBerry(int seed, BlockGTBush berryBush) {
        super(seed);
        this.berryBush = berryBush;
        this.WORLD_GEN_INSTANCE = new GTBerryGen(this);
    }
