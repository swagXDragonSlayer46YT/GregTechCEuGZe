...
public class BlockGTRootCrop extends BlockGTCrop {
    protected BlockGTRootCrop(String name) {
        super(name, 7);
    }

    public static BlockGTRootCrop create(String name) {
        AGE_TEMP = PropertyInteger.create("age", 0, 7);
        return new BlockGTRootCrop(name);
    }
