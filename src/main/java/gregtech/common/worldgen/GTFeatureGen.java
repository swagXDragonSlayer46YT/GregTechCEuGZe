...
public abstract class GTFeatureGen extends WorldGenerator {
    public final GTFeature feature;

    protected GTFeatureGen(boolean notify, GTFeature feature) {
        super(notify);
    ...
    public boolean generateInChunk(@NotNull World world, @NotNull Random random, int chunkX, int chunkZ) {
        if (!configOption())
            return false;
