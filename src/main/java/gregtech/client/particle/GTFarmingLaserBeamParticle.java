...
public class GTFarmingLaserBeamParticle extends GTLaserBeamParticle {

    private int particleAge;
    private final int particleMaxAge;
    public GTFarmingLaserBeamParticle(MetaTileEntity mte, Vector3 startPos, Vector3 endPos, int maxAge) {
