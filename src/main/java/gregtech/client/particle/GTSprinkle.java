...
public class GTSprinkle extends Particle {
    private double posXFinal, posYFinal, posZFinal;

    public GTSprinkle(World worldIn, double posXIn, double posYIn, double posZIn, double posXFinal, double posYFinal, double posZFinal, int color) {
