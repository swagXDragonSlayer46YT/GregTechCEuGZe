...
public class Textures {
    ...
    public static final OrientedOverlayRenderer WELDER_OVERLAY = new OrientedOverlayRenderer("machines/welder");
    ...
    public static final ResourceLocation MATH_CAPE_TEXTURE = gregtechId("textures/capes/mathcape.png");
    public static final ResourceLocation IMAGE_CAPE_TEXTURE = gregtechId("textures/capes/imagecape.png");
    public static final ResourceLocation BLG_CAPE_TEXTURE = gregtechId("textures/capes/blgcape.png");
